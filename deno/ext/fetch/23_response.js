...
function cloneInnerResponse(response) {
  ...
  const headerList = ArrayPrototypeMap(response.headerList, (x) => [
    x[0],
    x[1],
  ]);
...
const webidlConvertersResponseInit = (webidl.converters["ResponseInit"] =
  webidl.createDictionaryConverter("ResponseInit", [
    {
      key: "status",
      defaultValue: 200,
...
const webidlConvertersResponseInitFast = (webidl.converters[
  "ResponseInit_fast"
] = function (init, prefix, context, opts) {
