...
webidl.converters["PerformanceMarkOptions"] = webidl.createDictionaryConverter(
...
webidl.converters["PerformanceMeasureOptions"] =
  webidl.createDictionaryConverter("PerformanceMeasureOptions", [
    {
      key: "detail",
      converter: webidl.converters.any,
    },
  ...
  [SymbolFor("Deno.privateCustomInspect")](inspect, inspectOptions) {
    return inspect(
      createFilteredInspectProxy({
        object: this,
        evaluate: ObjectPrototypeIsPrototypeOf(PerformanceEntryPrototype, this),
        keys: ["name", "entryType", "startTime", "duration"],
      }),
      inspectOptions
    );
  }
...
class PerformanceMark extends PerformanceEntry {
  ...
  constructor(name, options = { __proto__: null }) {
  ...
  [SymbolFor("Deno.privateCustomInspect")](inspect, inspectOptions) {
    return inspect(
      createFilteredInspectProxy({
        ...
        keys: ["name", "entryType", "startTime", "duration", "detail"],
      }),
      inspectOptions
    );
  }
...
class Performance extends EventTarget {
  ...
  mark(markName, markOptions = { __proto__: null }) {
    webidl.assertBranded(this, PerformancePrototype);
  ...
  measure(
    ...
    ](startOrMeasureOptions, prefix, "Argument 2");
