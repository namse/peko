...
pub struct ModuleStreamProfileDetailsBody {
...
/// Required fields for ModuleStreamProfileDetailsBody
pub struct ModuleStreamProfileDetailsBodyRequired {
    /// The name of a module.
    pub module_name: String,
}

impl ModuleStreamProfileDetailsBody {
    /// Create a new ModuleStreamProfileDetailsBody with required fields
    pub fn new(required: ModuleStreamProfileDetailsBodyRequired) -> Self {
        Self {
