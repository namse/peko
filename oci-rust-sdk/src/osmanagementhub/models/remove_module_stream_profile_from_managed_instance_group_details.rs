...
pub struct RemoveModuleStreamProfileFromManagedInstanceGroupDetails {
...
/// Required fields for RemoveModuleStreamProfileFromManagedInstanceGroupDetails
pub struct RemoveModuleStreamProfileFromManagedInstanceGroupDetailsRequired {
    /// The name of the module.
    pub module_name: String,
}

impl RemoveModuleStreamProfileFromManagedInstanceGroupDetails {
    /// Create a new RemoveModuleStreamProfileFromManagedInstanceGroupDetails with required fields
    pub fn new(required: RemoveModuleStreamProfileFromManagedInstanceGroupDetailsRequired) -> Self {
        Self {
