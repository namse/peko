...
pub struct CreateThirdPartySoftwareSourceDetails {
...
/// Required fields for CreateThirdPartySoftwareSourceDetails
pub struct CreateThirdPartySoftwareSourceDetailsRequired {
    /// The OS family for the third-party software source.
    pub os_family: OsFamily,
...
impl CreateThirdPartySoftwareSourceDetails {
    /// Create a new CreateThirdPartySoftwareSourceDetails with required fields
    pub fn new(required: CreateThirdPartySoftwareSourceDetailsRequired) -> Self {
        Self {
