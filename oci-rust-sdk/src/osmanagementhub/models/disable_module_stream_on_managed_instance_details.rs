...
pub struct DisableModuleStreamOnManagedInstanceDetails {
...
/// Required fields for DisableModuleStreamOnManagedInstanceDetails
pub struct DisableModuleStreamOnManagedInstanceDetailsRequired {
    /// The name of a module.
    pub module_name: String,
}

impl DisableModuleStreamOnManagedInstanceDetails {
    /// Create a new DisableModuleStreamOnManagedInstanceDetails with required fields
    pub fn new(required: DisableModuleStreamOnManagedInstanceDetailsRequired) -> Self {
        Self {
