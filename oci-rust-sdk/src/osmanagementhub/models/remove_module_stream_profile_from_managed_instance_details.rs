...
pub struct RemoveModuleStreamProfileFromManagedInstanceDetails {
...
/// Required fields for RemoveModuleStreamProfileFromManagedInstanceDetails
pub struct RemoveModuleStreamProfileFromManagedInstanceDetailsRequired {
    /// The name of a module.
    pub module_name: String,
}

impl RemoveModuleStreamProfileFromManagedInstanceDetails {
    /// Create a new RemoveModuleStreamProfileFromManagedInstanceDetails with required fields
    pub fn new(required: RemoveModuleStreamProfileFromManagedInstanceDetailsRequired) -> Self {
        Self {
