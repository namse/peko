...
pub struct VersionedCustomSoftwareSourceSummary {
...
/// Required fields for VersionedCustomSoftwareSourceSummary
pub struct VersionedCustomSoftwareSourceSummaryRequired {
    /// List of vendor software sources that are used for the basis of the versioned custom software source.
    pub vendor_software_sources: Vec<Id>,
...
impl VersionedCustomSoftwareSourceSummary {
    /// Create a new VersionedCustomSoftwareSourceSummary with required fields
    pub fn new(required: VersionedCustomSoftwareSourceSummaryRequired) -> Self {
        Self {
