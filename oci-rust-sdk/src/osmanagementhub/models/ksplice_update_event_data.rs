...
pub struct KspliceUpdateEventData {
    /// The type of Ksplice update.
    pub operation_type: KspliceUpdateEventDataOperationType,
...
/// Required fields for KspliceUpdateEventData
pub struct KspliceUpdateEventDataRequired {
    /// The type of Ksplice update.
    pub operation_type: KspliceUpdateEventDataOperationType,
...
impl KspliceUpdateEventData {
    /// Create a new KspliceUpdateEventData with required fields
    pub fn new(required: KspliceUpdateEventDataRequired) -> Self {
        Self {
    ...
    /// Set operation_type
    pub fn set_operation_type(mut self, value: KspliceUpdateEventDataOperationType) -> Self {
