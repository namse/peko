...
pub struct DisableModuleStreamOnManagedInstanceGroupDetails {
...
/// Required fields for DisableModuleStreamOnManagedInstanceGroupDetails
pub struct DisableModuleStreamOnManagedInstanceGroupDetailsRequired {
    /// The name of the module.
    pub module_name: String,
}

impl DisableModuleStreamOnManagedInstanceGroupDetails {
    /// Create a new DisableModuleStreamOnManagedInstanceGroupDetails with required fields
    pub fn new(required: DisableModuleStreamOnManagedInstanceGroupDetailsRequired) -> Self {
        Self {
