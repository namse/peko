...
pub struct LifecycleStage {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub lifecycle_state: Option<LifecycleStageLifecycleState>,
...
/// Required fields for LifecycleStage
pub struct LifecycleStageRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that contains the lifecycle stage.
    pub compartment_id: String,
...
impl LifecycleStage {
    /// Create a new LifecycleStage with required fields
    pub fn new(required: LifecycleStageRequired) -> Self {
        Self {
    ...
    /// Set lifecycle_state
    pub fn set_lifecycle_state(mut self, value: Option<LifecycleStageLifecycleState>) -> Self {
    ...
    pub fn with_lifecycle_state(mut self, value: LifecycleStageLifecycleState) -> Self {
