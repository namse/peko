...
/// Required fields for WindowsUpdateSummary
pub struct WindowsUpdateSummaryRequired {
    /// Name of the Windows update.
    pub name: String,
...
impl WindowsUpdateSummary {
    /// Create a new WindowsUpdateSummary with required fields
    pub fn new(required: WindowsUpdateSummaryRequired) -> Self {
        Self {
            name: required.name,
