...
pub struct VersionedCustomSoftwareSource {
...
/// Required fields for VersionedCustomSoftwareSource
pub struct VersionedCustomSoftwareSourceRequired {
    /// List of vendor software sources that are used for the basis of the versioned custom software source.
    pub vendor_software_sources: Vec<Id>,
...
impl VersionedCustomSoftwareSource {
    /// Create a new VersionedCustomSoftwareSource with required fields
    pub fn new(required: VersionedCustomSoftwareSourceRequired) -> Self {
        Self {
