...
pub struct InstallModuleStreamProfileOnManagedInstanceGroupDetails {
...
/// Required fields for InstallModuleStreamProfileOnManagedInstanceGroupDetails
pub struct InstallModuleStreamProfileOnManagedInstanceGroupDetailsRequired {
    /// The name of the module.
    pub module_name: String,
}

impl InstallModuleStreamProfileOnManagedInstanceGroupDetails {
    /// Create a new InstallModuleStreamProfileOnManagedInstanceGroupDetails with required fields
    pub fn new(required: InstallModuleStreamProfileOnManagedInstanceGroupDetailsRequired) -> Self {
        Self {
