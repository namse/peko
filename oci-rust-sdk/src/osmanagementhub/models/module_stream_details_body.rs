...
pub struct ModuleStreamDetailsBody {
...
/// Required fields for ModuleStreamDetailsBody
pub struct ModuleStreamDetailsBodyRequired {
    /// The name of a module.
    pub module_name: String,
}

impl ModuleStreamDetailsBody {
    /// Create a new ModuleStreamDetailsBody with required fields
    pub fn new(required: ModuleStreamDetailsBodyRequired) -> Self {
        Self {
