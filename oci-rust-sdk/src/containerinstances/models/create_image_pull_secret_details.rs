...
pub struct CreateImagePullSecretDetails {
...
impl CreateImagePullSecretDetails {
    /// Create a new CreateImagePullSecretDetails with required fields
    pub fn new(required: CreateImagePullSecretDetailsRequired) -> Self {
        Self {
