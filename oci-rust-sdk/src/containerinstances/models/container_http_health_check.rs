...
pub struct ContainerHttpHealthCheck {
...
/// Required fields for ContainerHttpHealthCheck
pub struct ContainerHttpHealthCheckRequired {
    /// Container health check HTTP path.
    pub path: String,
...
impl ContainerHttpHealthCheck {
    /// Create a new ContainerHttpHealthCheck with required fields
    pub fn new(required: ContainerHttpHealthCheckRequired) -> Self {
        Self {
            path: required.path,
