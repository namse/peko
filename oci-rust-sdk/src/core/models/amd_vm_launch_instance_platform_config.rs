...
pub struct AmdVmLaunchInstancePlatformConfig {
    #[serde(rename = "type")]
    pub r#type: String,
...
/// Required fields for AmdVmLaunchInstancePlatformConfig
pub struct AmdVmLaunchInstancePlatformConfigRequired {
    pub r#type: String,
}

impl AmdVmLaunchInstancePlatformConfig {
    /// Create a new AmdVmLaunchInstancePlatformConfig with required fields
    pub fn new(required: AmdVmLaunchInstancePlatformConfigRequired) -> Self {
        Self {
