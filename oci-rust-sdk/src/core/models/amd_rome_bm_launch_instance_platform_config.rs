...
pub struct AmdRomeBmLaunchInstancePlatformConfig {
    #[serde(rename = "type")]
    pub r#type: String,

    /// The number of NUMA nodes per socket (NPS).
    #[serde(skip_serializing_if = "Option::is_none")]
    pub numa_nodes_per_socket: Option<AmdRomeBmLaunchInstancePlatformConfigNumaNodesPerSocket>,
...
/// Required fields for AmdRomeBmLaunchInstancePlatformConfig
pub struct AmdRomeBmLaunchInstancePlatformConfigRequired {
    pub r#type: String,
}

impl AmdRomeBmLaunchInstancePlatformConfig {
    /// Create a new AmdRomeBmLaunchInstancePlatformConfig with required fields
    pub fn new(required: AmdRomeBmLaunchInstancePlatformConfigRequired) -> Self {
        Self {
    ...
    pub fn set_numa_nodes_per_socket(
        mut self,
        value: Option<AmdRomeBmLaunchInstancePlatformConfigNumaNodesPerSocket>,
    ) -> Self {
    ...
    pub fn with_numa_nodes_per_socket(
        mut self,
        value: AmdRomeBmLaunchInstancePlatformConfigNumaNodesPerSocket,
    ) -> Self {
