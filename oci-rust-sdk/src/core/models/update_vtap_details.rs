...
pub struct UpdateVtapDetails {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub capture_filter_id: Option<String>,

    /// Defines an encapsulation header type for the VTAP's mirrored traffic.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub encapsulation_protocol: Option<UpdateVtapDetailsEncapsulationProtocol>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub traffic_mode: Option<UpdateVtapDetailsTrafficMode>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub target_type: Option<UpdateVtapDetailsTargetType>,

    /// The source type for the VTAP.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub source_type: Option<UpdateVtapDetailsSourceType>,
}

impl UpdateVtapDetails {
    /// Create a new UpdateVtapDetails
    pub fn new() -> Self {
        Self {
            defined_tags: None,
    ...
    /// Set source_id
    pub fn set_source_id(mut self, value: Option<String>) -> Self {
    ...
    pub fn set_capture_filter_id(mut self, value: Option<String>) -> Self {
    ...
    /// Set traffic_mode
    pub fn set_traffic_mode(mut self, value: Option<UpdateVtapDetailsTrafficMode>) -> Self {
    ...
    /// Set target_type
    pub fn set_target_type(mut self, value: Option<UpdateVtapDetailsTargetType>) -> Self {
        self.target_type = value;
        self
    }

    /// Set source_type
    pub fn set_source_type(mut self, value: Option<UpdateVtapDetailsSourceType>) -> Self {
    ...
    /// Set source_id (unwraps Option)
    pub fn with_source_id(mut self, value: impl Into<String>) -> Self {
    ...
    /// Set capture_filter_id (unwraps Option)
    pub fn with_capture_filter_id(mut self, value: impl Into<String>) -> Self {
        self.capture_filter_id = Some(value.into());
        self
    }
    ...
    pub fn with_traffic_mode(mut self, value: UpdateVtapDetailsTrafficMode) -> Self {
    ...
    pub fn with_target_type(mut self, value: UpdateVtapDetailsTargetType) -> Self {
        self.target_type = Some(value);
        self
    }

    /// Set source_type (unwraps Option)
    pub fn with_source_type(mut self, value: UpdateVtapDetailsSourceType) -> Self {
        self.source_type = Some(value);
        self
    }
}

impl Default for UpdateVtapDetails {
    fn default() -> Self {
        Self::new()
    }
}
