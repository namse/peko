...
pub struct UpdateComputeClusterDetails {
...
impl UpdateComputeClusterDetails {
    /// Create a new UpdateComputeClusterDetails
    pub fn new() -> Self {
        Self {
            display_name: None,
...
impl Default for UpdateComputeClusterDetails {
    fn default() -> Self {
        Self::new()
    }
}
