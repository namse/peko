...
pub struct ChangeInternetGatewayCompartmentDetails {
...
impl ChangeInternetGatewayCompartmentDetails {
    /// Create a new ChangeInternetGatewayCompartmentDetails with required fields
