...
pub struct AmdMilanBmLaunchInstancePlatformConfig {
    #[serde(rename = "type")]
    pub r#type: String,

    /// The number of NUMA nodes per socket (NPS).
    #[serde(skip_serializing_if = "Option::is_none")]
    pub numa_nodes_per_socket: Option<AmdMilanBmLaunchInstancePlatformConfigNumaNodesPerSocket>,
...
impl AmdMilanBmLaunchInstancePlatformConfig {
    /// Create a new AmdMilanBmLaunchInstancePlatformConfig with required fields
    pub fn new(required: AmdMilanBmLaunchInstancePlatformConfigRequired) -> Self {
        Self {
