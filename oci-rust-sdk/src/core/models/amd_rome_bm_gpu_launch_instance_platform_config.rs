...
pub struct AmdRomeBmGpuLaunchInstancePlatformConfig {
    #[serde(rename = "type")]
    pub r#type: String,

    /// The number of NUMA nodes per socket (NPS).
    #[serde(skip_serializing_if = "Option::is_none")]
    pub numa_nodes_per_socket: Option<AmdRomeBmGpuLaunchInstancePlatformConfigNumaNodesPerSocket>,
...
impl AmdRomeBmGpuLaunchInstancePlatformConfig {
    /// Create a new AmdRomeBmGpuLaunchInstancePlatformConfig with required fields
    pub fn new(required: AmdRomeBmGpuLaunchInstancePlatformConfigRequired) -> Self {
        Self {
