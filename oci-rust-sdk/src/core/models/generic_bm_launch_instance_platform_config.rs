...
pub struct GenericBmLaunchInstancePlatformConfig {
    #[serde(rename = "type")]
    pub r#type: String,

    /// The number of NUMA nodes per socket (NPS).
    #[serde(skip_serializing_if = "Option::is_none")]
    pub numa_nodes_per_socket: Option<GenericBmLaunchInstancePlatformConfigNumaNodesPerSocket>,
...
/// Required fields for GenericBmLaunchInstancePlatformConfig
pub struct GenericBmLaunchInstancePlatformConfigRequired {
    pub r#type: String,
}

impl GenericBmLaunchInstancePlatformConfig {
    /// Create a new GenericBmLaunchInstancePlatformConfig with required fields
    pub fn new(required: GenericBmLaunchInstancePlatformConfigRequired) -> Self {
        Self {
    ...
    pub fn set_numa_nodes_per_socket(
        mut self,
        value: Option<GenericBmLaunchInstancePlatformConfigNumaNodesPerSocket>,
    ) -> Self {
    ...
    pub fn with_numa_nodes_per_socket(
        mut self,
        value: GenericBmLaunchInstancePlatformConfigNumaNodesPerSocket,
    ) -> Self {
