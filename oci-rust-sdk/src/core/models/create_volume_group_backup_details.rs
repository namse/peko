...
pub struct CreateVolumeGroupBackupDetails {
...
impl CreateVolumeGroupBackupDetails {
    /// Create a new CreateVolumeGroupBackupDetails with required fields
    pub fn new(required: CreateVolumeGroupBackupDetailsRequired) -> Self {
        Self {
    ...
    /// Set r#type
    pub fn set_type(mut self, value: Option<CreateVolumeGroupBackupDetailsType>) -> Self {
        self.r#type = value;
        self
    }
    ...
    pub fn with_type(mut self, value: CreateVolumeGroupBackupDetailsType) -> Self {
