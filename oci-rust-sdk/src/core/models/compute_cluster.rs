...
use super::*;
/// A remote direct memory access (RDMA) network group. <p> A cluster network on a [compute cluster](https://docs.oracle.com/iaas/Content/Compute/Tasks/compute-clusters.htm) is a group of high performance computing (HPC), GPU, or optimized instances that are connected with an ultra low-latency network. <p> Use compute clusters when you want to manage instances in the cluster individually in the RDMA network group. <p> For details about cluster networks that use instance pools to manage groups of identical instances, see {@link ClusterNetwork}.
...
pub struct ComputeCluster {
    ...
    pub lifecycle_state: ComputeClusterLifecycleState,
...
impl ComputeCluster {
    /// Create a new ComputeCluster with required fields
    pub fn new(required: ComputeClusterRequired) -> Self {
        Self {
    ...
    /// Set lifecycle_state
    pub fn set_lifecycle_state(mut self, value: ComputeClusterLifecycleState) -> Self {
