...
pub struct ComputeGpuMemoryFabricSummary {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub firmware_update_state: Option<ComputeGpuMemoryFabricSummaryFirmwareUpdateState>,
...
/// Required fields for ComputeGpuMemoryFabricSummary
pub struct ComputeGpuMemoryFabricSummaryRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for the Customer-unique GPU memory fabric
    pub id: String,
...
impl ComputeGpuMemoryFabricSummary {
    /// Create a new ComputeGpuMemoryFabricSummary with required fields
    pub fn new(required: ComputeGpuMemoryFabricSummaryRequired) -> Self {
        Self {
            id: required.id,
    ...
    /// Set fabric_health
    pub fn set_fabric_health(mut self, value: String) -> Self {
    ...
    pub fn set_healthy_host_count(mut self, value: Option<i64>) -> Self {
    ...
    pub fn set_firmware_update_state(
        mut self,
        value: Option<ComputeGpuMemoryFabricSummaryFirmwareUpdateState>,
    ) -> Self {
    ...
    /// Set healthy_host_count (unwraps Option)
    pub fn with_healthy_host_count(mut self, value: i64) -> Self {
        self.healthy_host_count = Some(value);
        self
    }
    ...
    pub fn with_firmware_update_state(
        mut self,
        value: ComputeGpuMemoryFabricSummaryFirmwareUpdateState,
    ) -> Self {
