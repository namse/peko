...
pub struct CreateMacsecProperties {
    /// Indicates whether or not MACsec is enabled.
    pub state: MacsecState,

    #[serde(skip_serializing_if = "Option::is_none")]
    pub primary_key: Option<CreateMacsecKey>,
...
/// Required fields for CreateMacsecProperties
pub struct CreateMacsecPropertiesRequired {
    /// Indicates whether or not MACsec is enabled.
    pub state: MacsecState,
}

impl CreateMacsecProperties {
    /// Create a new CreateMacsecProperties with required fields
    pub fn new(required: CreateMacsecPropertiesRequired) -> Self {
        Self {
    ...
    /// Set primary_key
    pub fn set_primary_key(mut self, value: Option<CreateMacsecKey>) -> Self {
    ...
    pub fn with_primary_key(mut self, value: CreateMacsecKey) -> Self {
