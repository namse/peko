...
pub struct UpdateComputeCapacityReservationDetails {
...
impl UpdateComputeCapacityReservationDetails {
    /// Create a new UpdateComputeCapacityReservationDetails
    pub fn new() -> Self {
        Self {
            defined_tags: None,
...
impl Default for UpdateComputeCapacityReservationDetails {
    fn default() -> Self {
        Self::new()
    }
}
