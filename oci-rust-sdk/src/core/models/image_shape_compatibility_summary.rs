...
pub struct ImageShapeCompatibilitySummary {
...
impl ImageShapeCompatibilitySummary {
    /// Create a new ImageShapeCompatibilitySummary with required fields
    pub fn new(required: ImageShapeCompatibilitySummaryRequired) -> Self {
        Self {
