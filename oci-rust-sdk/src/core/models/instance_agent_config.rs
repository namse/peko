...
pub struct InstanceAgentConfig {
    ...
    /// Whether Oracle Cloud Agent can run all of the available plugins. This includes the management and monitoring plugins. <p> For more information about the available plugins, see [Managing Plugins with Oracle Cloud Agent](https://docs.oracle.com/iaas/Content/Compute/Tasks/manage-plugins.htm).
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl InstanceAgentConfig {
    /// Create a new InstanceAgentConfig
    pub fn new() -> Self {
        Self {
...
impl Default for InstanceAgentConfig {
    fn default() -> Self {
        Self::new()
    }
}
