...
pub struct ComputeHostGroup {
    ...
    pub lifecycle_state: ComputeHostGroupLifecycleState,
...
/// Required fields for ComputeHostGroup
pub struct ComputeHostGroupRequired {
    /// The availability domain of a host group. <p> Example: {@code Uocm:PHX-AD-1}
    pub availability_domain: String,
...
impl ComputeHostGroup {
    /// Create a new ComputeHostGroup with required fields
    pub fn new(required: ComputeHostGroupRequired) -> Self {
        Self {
    ...
    /// Set lifecycle_state
    pub fn set_lifecycle_state(mut self, value: ComputeHostGroupLifecycleState) -> Self {
