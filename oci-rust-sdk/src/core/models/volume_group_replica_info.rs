...
pub struct VolumeGroupReplicaInfo {
    ...
    /// The availability domain of the boot volume replica replica. <p> Example: {@code Uocm:PHX-AD-1}
...
/// Required fields for VolumeGroupReplicaInfo
pub struct VolumeGroupReplicaInfoRequired {
    /// A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
    pub display_name: String,
...
impl VolumeGroupReplicaInfo {
    /// Create a new VolumeGroupReplicaInfo with required fields
    pub fn new(required: VolumeGroupReplicaInfoRequired) -> Self {
        Self {
