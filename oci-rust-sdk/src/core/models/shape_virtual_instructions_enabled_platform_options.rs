...
pub struct ShapeVirtualInstructionsEnabledPlatformOptions {
...
impl ShapeVirtualInstructionsEnabledPlatformOptions {
    /// Create a new ShapeVirtualInstructionsEnabledPlatformOptions
    pub fn new() -> Self {
        Self {
            allowed_values: None,
...
impl Default for ShapeVirtualInstructionsEnabledPlatformOptions {
    fn default() -> Self {
        Self::new()
    }
}
