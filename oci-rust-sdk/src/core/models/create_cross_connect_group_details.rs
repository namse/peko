...
pub struct CreateCrossConnectGroupDetails {
...
impl CreateCrossConnectGroupDetails {
    /// Create a new CreateCrossConnectGroupDetails with required fields
    pub fn new(required: CreateCrossConnectGroupDetailsRequired) -> Self {
        Self {
