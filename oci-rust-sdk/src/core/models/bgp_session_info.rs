...
pub struct BgpSessionInfo {
    ...
    /// The Oracle BGP ASN.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub oracle_bgp_asn: Option<String>,

    /// If the tunnel's {@code routing} attribute is set to {@code BGP} (see {@link IPSecConnectionTunnel}), this ASN is required and used for the tunnel's BGP session. This is the ASN of the network on the CPE end of the BGP session. Can be a 2-byte or 4-byte ASN. Uses \"asplain\" format. <p> If the tunnel uses static routing, the {@code customerBgpAsn} must be null. <p> Example: {@code 12345} (2-byte) or {@code 1587232876} (4-byte)
    #[serde(skip_serializing_if = "Option::is_none")]
    pub customer_bgp_asn: Option<String>,

    /// The state of the BGP session.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub bgp_state: Option<BgpSessionInfoBgpState>,

    /// The state of the BGP IPv6 session.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub bgp_ipv6_state: Option<BgpSessionInfoBgpIpv6State>,
}

impl BgpSessionInfo {
    /// Create a new BgpSessionInfo
    pub fn new() -> Self {
        Self {
    ...
    /// Set oracle_bgp_asn
    pub fn set_oracle_bgp_asn(mut self, value: Option<String>) -> Self {
    ...
    /// Set bgp_state
    pub fn set_bgp_state(mut self, value: Option<BgpSessionInfoBgpState>) -> Self {
        self.bgp_state = value;
        self
    }

    /// Set bgp_ipv6_state
    pub fn set_bgp_ipv6_state(mut self, value: Option<BgpSessionInfoBgpIpv6State>) -> Self {
        self.bgp_ipv6_state = value;
        self
    }
    ...
    pub fn with_oracle_bgp_asn(mut self, value: impl Into<String>) -> Self {
        self.oracle_bgp_asn = Some(value.into());
        self
    }
    ...
    /// Set bgp_state (unwraps Option)
    pub fn with_bgp_state(mut self, value: BgpSessionInfoBgpState) -> Self {
        self.bgp_state = Some(value);
        self
    }

    /// Set bgp_ipv6_state (unwraps Option)
    pub fn with_bgp_ipv6_state(mut self, value: BgpSessionInfoBgpIpv6State) -> Self {
        self.bgp_ipv6_state = Some(value);
        self
    }
}

impl Default for BgpSessionInfo {
    fn default() -> Self {
        Self::new()
    }
}
