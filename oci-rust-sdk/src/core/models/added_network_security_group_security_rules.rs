...
pub struct AddedNetworkSecurityGroupSecurityRules {
    /// The NSG security rules that were added.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub security_rules: Option<Vec<SecurityRule>>,
}

impl AddedNetworkSecurityGroupSecurityRules {
    /// Create a new AddedNetworkSecurityGroupSecurityRules
    pub fn new() -> Self {
        Self {
            security_rules: None,
        }
...
impl Default for AddedNetworkSecurityGroupSecurityRules {
    fn default() -> Self {
        Self::new()
    }
}
