...
pub struct ComputeHpcIsland {
    ...
    pub lifecycle_state: ComputeHpcIslandLifecycleState,
...
/// Required fields for ComputeHpcIsland
pub struct ComputeHpcIslandRequired {
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute capacity topology.
    pub compute_capacity_topology_id: String,
...
impl ComputeHpcIsland {
    /// Create a new ComputeHpcIsland with required fields
    pub fn new(required: ComputeHpcIslandRequired) -> Self {
        Self {
    ...
    /// Set lifecycle_state
    pub fn set_lifecycle_state(mut self, value: ComputeHpcIslandLifecycleState) -> Self {
