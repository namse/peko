...
pub struct ChangeVirtualCircuitCompartmentDetails {
...
impl ChangeVirtualCircuitCompartmentDetails {
    /// Create a new ChangeVirtualCircuitCompartmentDetails with required fields
