...
pub struct UpdateInstanceAgentConfigDetails {
...
impl UpdateInstanceAgentConfigDetails {
    /// Create a new UpdateInstanceAgentConfigDetails
    pub fn new() -> Self {
        Self {
...
impl Default for UpdateInstanceAgentConfigDetails {
    fn default() -> Self {
        Self::new()
    }
}
