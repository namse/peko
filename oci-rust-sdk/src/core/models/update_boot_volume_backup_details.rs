...
pub struct UpdateBootVolumeBackupDetails {
...
impl UpdateBootVolumeBackupDetails {
    /// Create a new UpdateBootVolumeBackupDetails
    pub fn new() -> Self {
        Self {
            defined_tags: None,
...
impl Default for UpdateBootVolumeBackupDetails {
    fn default() -> Self {
        Self::new()
    }
}
