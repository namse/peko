...
pub struct InstanceConfigurationCreateVolumeDetails {
    ...
    /// Specifies whether the auto-tune performance is enabled for this boot volume. This field is deprecated. Use the {@code InstanceConfigurationDetachedVolumeAutotunePolicy} instead to enable the volume for detached autotune.
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub block_volume_replicas: Option<Vec<InstanceConfigurationBlockVolumeReplicaDetails>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub autotune_policies: Option<Vec<InstanceConfigurationAutotunePolicy>>,
...
impl InstanceConfigurationCreateVolumeDetails {
    /// Create a new InstanceConfigurationCreateVolumeDetails
    pub fn new() -> Self {
        Self {
