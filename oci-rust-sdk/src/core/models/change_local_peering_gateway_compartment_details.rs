...
pub struct ChangeLocalPeeringGatewayCompartmentDetails {
...
impl ChangeLocalPeeringGatewayCompartmentDetails {
    /// Create a new ChangeLocalPeeringGatewayCompartmentDetails with required fields
