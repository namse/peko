...
pub struct AddSecurityRuleDetails {
    ...
    pub direction: AddSecurityRuleDetailsDirection,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub destination_type: Option<AddSecurityRuleDetailsDestinationType>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub source_type: Option<AddSecurityRuleDetailsSourceType>,
...
/// Required fields for AddSecurityRuleDetails
pub struct AddSecurityRuleDetailsRequired {
    /// Direction of the security rule. Set to {@code EGRESS} for rules to allow outbound IP packets, or {@code INGRESS} for rules to allow inbound IP packets.
    pub direction: AddSecurityRuleDetailsDirection,
...
impl AddSecurityRuleDetails {
    /// Create a new AddSecurityRuleDetails with required fields
    pub fn new(required: AddSecurityRuleDetailsRequired) -> Self {
        Self {
    ...
    pub fn set_destination_type(
        mut self,
        value: Option<AddSecurityRuleDetailsDestinationType>,
    ) -> Self {
    ...
    /// Set direction
    pub fn set_direction(mut self, value: AddSecurityRuleDetailsDirection) -> Self {
    ...
    /// Set source_type
    pub fn set_source_type(mut self, value: Option<AddSecurityRuleDetailsSourceType>) -> Self {
    ...
    pub fn with_destination_type(mut self, value: AddSecurityRuleDetailsDestinationType) -> Self {
    ...
    pub fn with_source_type(mut self, value: AddSecurityRuleDetailsSourceType) -> Self {
