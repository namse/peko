...
pub struct LaunchInstanceAvailabilityConfigDetails {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub recovery_action: Option<LaunchInstanceAvailabilityConfigDetailsRecoveryAction>,
}

impl LaunchInstanceAvailabilityConfigDetails {
    /// Create a new LaunchInstanceAvailabilityConfigDetails
    pub fn new() -> Self {
        Self {
...
impl Default for LaunchInstanceAvailabilityConfigDetails {
    fn default() -> Self {
        Self::new()
    }
}
