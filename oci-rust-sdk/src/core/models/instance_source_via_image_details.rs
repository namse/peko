...
pub struct InstanceSourceViaImageDetails {
...
impl InstanceSourceViaImageDetails {
    /// Create a new InstanceSourceViaImageDetails with required fields
    pub fn new(required: InstanceSourceViaImageDetailsRequired) -> Self {
        Self {
