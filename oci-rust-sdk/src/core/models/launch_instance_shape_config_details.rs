...
pub struct LaunchInstanceShapeConfigDetails {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub baseline_ocpu_utilization: Option<LaunchInstanceShapeConfigDetailsBaselineOcpuUtilization>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub resource_management: Option<LaunchInstanceShapeConfigDetailsResourceManagement>,
}

impl LaunchInstanceShapeConfigDetails {
    /// Create a new LaunchInstanceShapeConfigDetails
    pub fn new() -> Self {
        Self {
            ocpus: None,
