...
pub struct UpdateInternetGatewayDetails {
...
impl UpdateInternetGatewayDetails {
    /// Create a new UpdateInternetGatewayDetails
    pub fn new() -> Self {
        Self {
            defined_tags: None,
...
impl Default for UpdateInternetGatewayDetails {
    fn default() -> Self {
        Self::new()
    }
}
