...
pub struct CreateRouteTableDetails {
...
impl CreateRouteTableDetails {
    /// Create a new CreateRouteTableDetails with required fields
    pub fn new(required: CreateRouteTableDetailsRequired) -> Self {
        Self {
