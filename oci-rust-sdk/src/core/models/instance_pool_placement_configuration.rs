...
pub struct InstancePoolPlacementConfiguration {
...
impl InstancePoolPlacementConfiguration {
    /// Create a new InstancePoolPlacementConfiguration with required fields
    pub fn new(required: InstancePoolPlacementConfigurationRequired) -> Self {
        Self {
