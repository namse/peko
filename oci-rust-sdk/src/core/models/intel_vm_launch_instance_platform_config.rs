...
pub struct IntelVmLaunchInstancePlatformConfig {
    #[serde(rename = "type")]
    pub r#type: String,
...
impl IntelVmLaunchInstancePlatformConfig {
    /// Create a new IntelVmLaunchInstancePlatformConfig with required fields
    pub fn new(required: IntelVmLaunchInstancePlatformConfigRequired) -> Self {
        Self {
