...
pub struct ChangeComputeHostGroupCompartmentDetails {
...
impl ChangeComputeHostGroupCompartmentDetails {
    /// Create a new ChangeComputeHostGroupCompartmentDetails with required fields
