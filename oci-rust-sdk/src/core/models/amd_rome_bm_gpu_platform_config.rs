...
pub struct AmdRomeBmGpuPlatformConfig {
    ...
    pub numa_nodes_per_socket: Option<AmdRomeBmGpuPlatformConfigNumaNodesPerSocket>,
...
/// Required fields for AmdRomeBmGpuPlatformConfig
pub struct AmdRomeBmGpuPlatformConfigRequired {
    pub r#type: String,
}

impl AmdRomeBmGpuPlatformConfig {
    /// Create a new AmdRomeBmGpuPlatformConfig with required fields
    pub fn new(required: AmdRomeBmGpuPlatformConfigRequired) -> Self {
        Self {
    ...
    pub fn set_numa_nodes_per_socket(
        mut self,
        value: Option<AmdRomeBmGpuPlatformConfigNumaNodesPerSocket>,
    ) -> Self {
    ...
    pub fn with_numa_nodes_per_socket(
        mut self,
        value: AmdRomeBmGpuPlatformConfigNumaNodesPerSocket,
    ) -> Self {
