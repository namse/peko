...
pub struct AmdRomeBmPlatformConfig {
    ...
    pub numa_nodes_per_socket: Option<AmdRomeBmPlatformConfigNumaNodesPerSocket>,
...
/// Required fields for AmdRomeBmPlatformConfig
pub struct AmdRomeBmPlatformConfigRequired {
    pub r#type: String,
}

impl AmdRomeBmPlatformConfig {
    /// Create a new AmdRomeBmPlatformConfig with required fields
    pub fn new(required: AmdRomeBmPlatformConfigRequired) -> Self {
        Self {
    ...
    pub fn set_numa_nodes_per_socket(
        mut self,
        value: Option<AmdRomeBmPlatformConfigNumaNodesPerSocket>,
    ) -> Self {
    ...
    pub fn with_numa_nodes_per_socket(
        mut self,
        value: AmdRomeBmPlatformConfigNumaNodesPerSocket,
    ) -> Self {
