...
use super::*;
/// For use with Oracle Cloud Infrastructure FastConnect. A cross-connect group is a link aggregation group (LAG), which can contain one or more {@link CrossConnect}. Customers who are colocated with Oracle in a FastConnect location create and use cross-connect groups. For more information, see [FastConnect Overview](https://docs.oracle.com/iaas/Content/Network/Concepts/fastconnect.htm). <p> *Note:** If you're a provider who is setting up a physical connection to Oracle so customers can use FastConnect over the connection, be aware that your connection is modeled the same way as a colocated customer's (with {@code CrossConnect} and {@code CrossConnectGroup} objects, and so on). <p> To use any of the API operations, you must be authorized in an IAM policy. If you're not authorized, talk to an administrator. If you're an administrator who needs to write policies to give users access, see [Getting Started with Policies](https://docs.oracle.com/iaas/Content/Identity/Concepts/policygetstarted.htm).
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct CrossConnectGroup {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub lifecycle_state: Option<CrossConnectGroupLifecycleState>,
    ...
    /// The date and time the cross-connect group was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339). <p> Example: {@code 2016-08-25T21:10:29.600Z}
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl CrossConnectGroup {
    /// Create a new CrossConnectGroup
    pub fn new() -> Self {
        Self {
            compartment_id: None,
    ...
    /// Set lifecycle_state
    pub fn set_lifecycle_state(mut self, value: Option<CrossConnectGroupLifecycleState>) -> Self {
    ...
    pub fn with_lifecycle_state(mut self, value: CrossConnectGroupLifecycleState) -> Self {
...
impl Default for CrossConnectGroup {
    fn default() -> Self {
        Self::new()
    }
}
