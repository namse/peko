...
pub struct IntelSkylakeBmPlatformConfig {
    ...
    pub numa_nodes_per_socket: Option<IntelSkylakeBmPlatformConfigNumaNodesPerSocket>,
...
/// Required fields for IntelSkylakeBmPlatformConfig
pub struct IntelSkylakeBmPlatformConfigRequired {
    pub r#type: String,
}

impl IntelSkylakeBmPlatformConfig {
    /// Create a new IntelSkylakeBmPlatformConfig with required fields
    pub fn new(required: IntelSkylakeBmPlatformConfigRequired) -> Self {
        Self {
    ...
    pub fn set_numa_nodes_per_socket(
        mut self,
        value: Option<IntelSkylakeBmPlatformConfigNumaNodesPerSocket>,
    ) -> Self {
    ...
    pub fn with_numa_nodes_per_socket(
        mut self,
        value: IntelSkylakeBmPlatformConfigNumaNodesPerSocket,
    ) -> Self {
