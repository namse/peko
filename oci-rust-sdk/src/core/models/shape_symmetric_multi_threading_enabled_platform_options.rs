...
pub struct ShapeSymmetricMultiThreadingEnabledPlatformOptions {
...
impl ShapeSymmetricMultiThreadingEnabledPlatformOptions {
    /// Create a new ShapeSymmetricMultiThreadingEnabledPlatformOptions
    pub fn new() -> Self {
        Self {
            allowed_values: None,
...
impl Default for ShapeSymmetricMultiThreadingEnabledPlatformOptions {
    fn default() -> Self {
        Self::new()
    }
}
