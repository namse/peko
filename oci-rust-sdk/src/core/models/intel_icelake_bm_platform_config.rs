...
pub struct IntelIcelakeBmPlatformConfig {
    ...
    pub numa_nodes_per_socket: Option<IntelIcelakeBmPlatformConfigNumaNodesPerSocket>,
...
/// Required fields for IntelIcelakeBmPlatformConfig
pub struct IntelIcelakeBmPlatformConfigRequired {
    pub r#type: String,
}

impl IntelIcelakeBmPlatformConfig {
    /// Create a new IntelIcelakeBmPlatformConfig with required fields
    pub fn new(required: IntelIcelakeBmPlatformConfigRequired) -> Self {
        Self {
    ...
    pub fn set_numa_nodes_per_socket(
        mut self,
        value: Option<IntelIcelakeBmPlatformConfigNumaNodesPerSocket>,
    ) -> Self {
    ...
    pub fn with_numa_nodes_per_socket(
        mut self,
        value: IntelIcelakeBmPlatformConfigNumaNodesPerSocket,
    ) -> Self {
