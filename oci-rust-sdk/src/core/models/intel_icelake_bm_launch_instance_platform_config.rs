...
pub struct IntelIcelakeBmLaunchInstancePlatformConfig {
    #[serde(rename = "type")]
    pub r#type: String,

    /// The number of NUMA nodes per socket (NPS).
    #[serde(skip_serializing_if = "Option::is_none")]
    pub numa_nodes_per_socket: Option<IntelIcelakeBmLaunchInstancePlatformConfigNumaNodesPerSocket>,
...
impl IntelIcelakeBmLaunchInstancePlatformConfig {
    /// Create a new IntelIcelakeBmLaunchInstancePlatformConfig with required fields
    pub fn new(required: IntelIcelakeBmLaunchInstancePlatformConfigRequired) -> Self {
        Self {
