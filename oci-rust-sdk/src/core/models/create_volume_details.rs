...
pub struct CreateVolumeDetails {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub volume_backup_id: Option<String>,
...
impl CreateVolumeDetails {
    /// Create a new CreateVolumeDetails with required fields
    pub fn new(required: CreateVolumeDetailsRequired) -> Self {
        Self {
    ...
    pub fn set_volume_backup_id(mut self, value: Option<String>) -> Self {
    ...
    /// Set volume_backup_id (unwraps Option)
    pub fn with_volume_backup_id(mut self, value: impl Into<String>) -> Self {
        self.volume_backup_id = Some(value.into());
        self
    }
