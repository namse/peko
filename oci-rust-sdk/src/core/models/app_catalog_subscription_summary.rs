...
pub struct AppCatalogSubscriptionSummary {
...
impl AppCatalogSubscriptionSummary {
    /// Create a new AppCatalogSubscriptionSummary
    pub fn new() -> Self {
        Self {
            publisher_name: None,
...
impl Default for AppCatalogSubscriptionSummary {
    fn default() -> Self {
        Self::new()
    }
}
