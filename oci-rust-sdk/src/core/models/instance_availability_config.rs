...
impl InstanceAvailabilityConfig {
    /// Create a new InstanceAvailabilityConfig
    pub fn new() -> Self {
        Self {
    ...
    pub fn with_recovery_action(mut self, value: InstanceAvailabilityConfigRecoveryAction) -> Self {
        self.recovery_action = Some(value);
        self
    }
}

impl Default for InstanceAvailabilityConfig {
    fn default() -> Self {
        Self::new()
    }
}
