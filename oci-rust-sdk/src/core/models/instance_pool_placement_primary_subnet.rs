...
pub struct InstancePoolPlacementPrimarySubnet {
...
impl InstancePoolPlacementPrimarySubnet {
    /// Create a new InstancePoolPlacementPrimarySubnet with required fields
    pub fn new(required: InstancePoolPlacementPrimarySubnetRequired) -> Self {
        Self {
