...
impl LaunchInstancePlatformConfig {
    /// Create a new LaunchInstancePlatformConfig with required fields
    pub fn new(required: LaunchInstancePlatformConfigRequired) -> Self {
        Self {
