...
pub struct UpdatePrivateIpDetails {
    ...
    /// The [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VNIC to reassign the private IP to. The VNIC must be in the same subnet as the current VNIC.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub vnic_id: Option<String>,

    /// Lifetime of the IP address. There are two types of IPs: - Ephemeral - Reserved
    #[serde(skip_serializing_if = "Option::is_none")]
    pub lifetime: Option<UpdatePrivateIpDetailsLifetime>,
...
impl UpdatePrivateIpDetails {
    /// Create a new UpdatePrivateIpDetails
    pub fn new() -> Self {
        Self {
            defined_tags: None,
    ...
    /// Set lifetime
    pub fn set_lifetime(mut self, value: Option<UpdatePrivateIpDetailsLifetime>) -> Self {
        self.lifetime = value;
        self
    }
    ...
    pub fn with_lifetime(mut self, value: UpdatePrivateIpDetailsLifetime) -> Self {
...
impl Default for UpdatePrivateIpDetails {
    fn default() -> Self {
        Self::new()
    }
}
