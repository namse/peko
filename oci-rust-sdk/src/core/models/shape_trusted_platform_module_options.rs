...
pub struct ShapeTrustedPlatformModuleOptions {
...
impl ShapeTrustedPlatformModuleOptions {
    /// Create a new ShapeTrustedPlatformModuleOptions
    pub fn new() -> Self {
        Self {
            allowed_values: None,
...
impl Default for ShapeTrustedPlatformModuleOptions {
    fn default() -> Self {
        Self::new()
    }
}
