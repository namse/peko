...
pub struct IntelVmUpdateInstancePlatformConfig {
    #[serde(rename = "type")]
    pub r#type: String,
...
impl IntelVmUpdateInstancePlatformConfig {
    /// Create a new IntelVmUpdateInstancePlatformConfig with required fields
    pub fn new(required: IntelVmUpdateInstancePlatformConfigRequired) -> Self {
        Self {
