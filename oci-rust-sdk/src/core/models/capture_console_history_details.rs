...
pub struct CaptureConsoleHistoryDetails {
...
impl CaptureConsoleHistoryDetails {
    /// Create a new CaptureConsoleHistoryDetails with required fields
    pub fn new(required: CaptureConsoleHistoryDetailsRequired) -> Self {
        Self {
