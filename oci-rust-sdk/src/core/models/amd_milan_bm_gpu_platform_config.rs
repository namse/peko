...
pub struct AmdMilanBmGpuPlatformConfig {
    ...
    pub numa_nodes_per_socket: Option<AmdMilanBmGpuPlatformConfigNumaNodesPerSocket>,
...
/// Required fields for AmdMilanBmGpuPlatformConfig
pub struct AmdMilanBmGpuPlatformConfigRequired {
    pub r#type: String,
}

impl AmdMilanBmGpuPlatformConfig {
    /// Create a new AmdMilanBmGpuPlatformConfig with required fields
    pub fn new(required: AmdMilanBmGpuPlatformConfigRequired) -> Self {
        Self {
    ...
    pub fn set_numa_nodes_per_socket(
        mut self,
        value: Option<AmdMilanBmGpuPlatformConfigNumaNodesPerSocket>,
    ) -> Self {
    ...
    pub fn with_numa_nodes_per_socket(
        mut self,
        value: AmdMilanBmGpuPlatformConfigNumaNodesPerSocket,
    ) -> Self {
