...
impl PublicIpPool {
    /// Create a new PublicIpPool with required fields
    pub fn new(required: PublicIpPoolRequired) -> Self {
        Self {
    ...
    /// Set lifecycle_state
    pub fn set_lifecycle_state(mut self, value: Option<PublicIpPoolLifecycleState>) -> Self {
    ...
    pub fn with_lifecycle_state(mut self, value: PublicIpPoolLifecycleState) -> Self {
