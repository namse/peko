...
pub struct UpdateComputeGpuMemoryFabricDetails {
...
impl UpdateComputeGpuMemoryFabricDetails {
    /// Create a new UpdateComputeGpuMemoryFabricDetails
    pub fn new() -> Self {
        Self {
            defined_tags: None,
...
impl Default for UpdateComputeGpuMemoryFabricDetails {
    fn default() -> Self {
        Self::new()
    }
}
