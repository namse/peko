...
pub struct AttachParavirtualizedVolumeDetails {
    #[serde(rename = "type")]
    pub r#type: String,
...
/// Required fields for AttachParavirtualizedVolumeDetails
pub struct AttachParavirtualizedVolumeDetailsRequired {
    pub r#type: String,
}

impl AttachParavirtualizedVolumeDetails {
    /// Create a new AttachParavirtualizedVolumeDetails with required fields
    pub fn new(required: AttachParavirtualizedVolumeDetailsRequired) -> Self {
        Self {
