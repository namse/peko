...
pub struct ChangeInstanceConfigurationCompartmentDetails {
...
impl ChangeInstanceConfigurationCompartmentDetails {
    /// Create a new ChangeInstanceConfigurationCompartmentDetails with required fields
