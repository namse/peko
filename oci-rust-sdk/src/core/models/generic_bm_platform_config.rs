...
pub struct GenericBmPlatformConfig {
    ...
    pub numa_nodes_per_socket: Option<GenericBmPlatformConfigNumaNodesPerSocket>,
...
impl GenericBmPlatformConfig {
    /// Create a new GenericBmPlatformConfig with required fields
    pub fn new(required: GenericBmPlatformConfigRequired) -> Self {
        Self {
