...
pub struct AmdMilanBmPlatformConfig {
    ...
    pub numa_nodes_per_socket: Option<AmdMilanBmPlatformConfigNumaNodesPerSocket>,
...
/// Required fields for AmdMilanBmPlatformConfig
pub struct AmdMilanBmPlatformConfigRequired {
    pub r#type: String,
}

impl AmdMilanBmPlatformConfig {
    /// Create a new AmdMilanBmPlatformConfig with required fields
    pub fn new(required: AmdMilanBmPlatformConfigRequired) -> Self {
        Self {
    ...
    pub fn set_numa_nodes_per_socket(
        mut self,
        value: Option<AmdMilanBmPlatformConfigNumaNodesPerSocket>,
    ) -> Self {
    ...
    pub fn with_numa_nodes_per_socket(
        mut self,
        value: AmdMilanBmPlatformConfigNumaNodesPerSocket,
    ) -> Self {
