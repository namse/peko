...
pub struct InstancePoolPlacementSubnetDetails {
...
/// Required fields for InstancePoolPlacementSubnetDetails
pub struct InstancePoolPlacementSubnetDetailsRequired {
    /// The subnet [OCID](https://docs.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for the secondary VNIC.
    pub subnet_id: String,
}

impl InstancePoolPlacementSubnetDetails {
    /// Create a new InstancePoolPlacementSubnetDetails with required fields
    pub fn new(required: InstancePoolPlacementSubnetDetailsRequired) -> Self {
        Self {
