...
pub struct InstanceConfigurationAmdVmLaunchInstancePlatformConfig {
    #[serde(rename = "type")]
    pub r#type: String,
...
impl InstanceConfigurationAmdVmLaunchInstancePlatformConfig {
    /// Create a new InstanceConfigurationAmdVmLaunchInstancePlatformConfig with required fields
    pub fn new(required: InstanceConfigurationAmdVmLaunchInstancePlatformConfigRequired) -> Self {
        Self {
